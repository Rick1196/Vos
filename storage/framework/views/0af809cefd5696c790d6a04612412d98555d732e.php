<?php $__env->startSection('resident'); ?>
    ...
    <section>
        <form method="POST" action="<?php echo e(route('tipos_de_residentes.update', $typeOfResident->id)); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="field"><br>
                ...
                <input id="type" name="type" class="input" type="text" placeholder="Aquí el tipo de residente"
                       value="<?php echo e($typeOfResident->type); ?>">
            ...
            <div class="field">
                ...
                <input id="description" name="description" class="input" type="text" placeholder="Aquí su descripción"
                       value="<?php echo e($typeOfResident->description); ?>">
...
<?php echo $__env->make('resident', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\vos\resources\views/type_residents/edit.blade.php ENDPATH**/ ?>