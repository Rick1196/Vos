<?php $__env->startSection('condominium'); ?>
    ...
    <section>
        <form method="POST" action="<?php echo e(route('condominium.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="field">
...
<?php echo $__env->make('condominium', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ricardo/Documents/projects/personal/php/laravel/vos/resources/views/condominiums/create.blade.php ENDPATH**/ ?>